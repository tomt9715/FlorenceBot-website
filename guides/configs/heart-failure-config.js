...
const sidebarConfig = {
    ...
    clinicalPearls: [
        { title: 'Left = Lungs', text: 'Left-sided HF causes pulmonary symptoms (dyspnea, crackles, orthopnea). Right-sided HF causes systemic symptoms (edema, JVD).' },
        { title: 'Daily Weights', text: 'Most sensitive indicator of fluid status. Same time, same scale, same clothing. Report 2+ lbs/day or 5+ lbs/week.' },
        { title: 'LMNOP for Acute HF', text: 'Lasix, Morphine, Nitrates, Oxygen, Position (high Fowlers) - priority interventions for acute decompensation.' },
        { title: 'Prevent Valsalva', text: 'Straining during BMs drops cardiac output. Give stool softeners prophylactically to all HF patients.' },
        { title: 'Normal EF Trap', text: 'HFpEF patients have normal EF but still have HF - their stiff heart fills poorly during diastole.' },
        { title: 'Watch Potassium', text: 'Loop diuretics cause hypokalemia. ACE-I/ARBs cause hyperkalemia. Hold ACE-I if K+ > 5.5 mEq/L.' }
    ]
};
