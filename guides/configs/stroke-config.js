...
const sidebarConfig = {
    ...
    clinicalPearls: [
        { title: 'CT Before tPA!', text: 'Always get non-contrast CT to rule out hemorrhage before giving thrombolytics.' },
        { title: 'NPO First', text: 'Keep patient NPO until swallow screen completed. Dysphagia occurs in up to 78% of stroke patients.' },
        { title: 'Time = Brain', text: 'Note the exact time symptoms started—this determines tPA eligibility.' },
        { title: 'Watch for A-fib', text: 'Continuous cardiac monitoring helps identify atrial fibrillation as embolic stroke source.' },
        { title: 'Permissive HTN', text: 'Without tPA, allow BP up to 220/120 to maintain cerebral perfusion.' }
    ]
};
