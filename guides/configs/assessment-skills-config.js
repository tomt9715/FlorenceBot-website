...
const sidebarConfig = {
    ...
    clinicalPearls: [
        { title: 'IPPA Order', text: 'Inspect, Palpate, Percuss, Auscultate. Exception: Abdomen - auscultate BEFORE palpation to avoid altering bowel sounds.' },
        { title: 'Trends Over Single Values', text: 'A single vital sign provides limited info. Compare trends over time to the patient\'s baseline.' },
        { title: 'SBAR Communication', text: 'Situation, Background, Assessment, Recommendation - use this format when calling providers.' },
        { title: 'Document Objectively', text: '"If it wasn\'t documented, it wasn\'t done." Use measurable terms, avoid vague language.' },
        { title: 'Trust Your Gut', text: '"Worried about the patient" is a valid reason to call Rapid Response - trust your nursing instincts.' },
        { title: 'Pain Assessment: PQRST', text: 'Provokes/Palliates, Quality, Radiates, Severity (0-10), Timing - complete pain evaluation.' }
    ]
};
